...
values
  ...
  ('middle-sound-waves', 'sound-waves', 'Sound: Pitch, Loudness & Speed', 'Watch a longitudinal sound wave move through matter and measure its arrival at two microphones.', 'middle', 'waves', 'pack', 15, array['Sound', 'Pitch', 'Sound Level', 'Propagation Speed'], 'waves', true, 110),
  ('middle-electrical-power-energy', 'electrical-power-energy', 'Electrical Power & Energy', 'Compare two resistive loads and see how power sets the rate at which electrical energy is transferred.', 'middle', 'electricity', 'pack', 15, array['Electrical Power', 'Electrical Energy', 'Ohm''s Law', 'Energy Transfer'], 'circuit', true, 120),
  ('middle-electromagnets', 'electromagnets', 'Electromagnets: Current, Coils & Polarity', 'Change current, turns, core material, and direction to predict magnetic field strength and polarity.', 'middle', 'electricity', 'pack', 15, array['Electromagnets', 'Magnetic Fields', 'Polarity', 'Right-hand Rule'], 'circuit', true, 130),
  ('middle-lenses-image-formation', 'lenses-image-formation', 'Lenses & Image Formation', 'Construct three principal rays and predict real or virtual images for converging and diverging lenses.', 'middle', 'optics', 'pack', 15, array['Thin Lenses', 'Principal Rays', 'Focal Length', 'Magnification'], 'optics', true, 140)
