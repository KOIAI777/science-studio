...
alter table public.experiments
  ...
  check (subject in ('mechanics', 'electricity', 'waves', 'fluids', 'optics'));
...
alter table public.experiments
  ...
  check (preview in ('incline', 'lever', 'motion', 'energy', 'circuit', 'projectile', 'collision', 'orbit', 'waves', 'buoyancy', 'optics'));
