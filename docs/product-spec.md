...
| Middle School Physics Foundations | 计划约 15 个初中物理实验 | Early Access 已开放；十个付费实验已发布，后续通过验证的同包实验继续加入 |
...
四个免费实验保持匿名开放。教师邮箱 Magic Link、一次性 Waffo Pancake Checkout、签名 Webhook、订单与 entitlement 已接入；十个付费实验共用教师账户的 active `Middle School Physics Foundations` 权益。当前不销售订阅；同包后续实验只有在完成课堂和科学验证后才加入。
