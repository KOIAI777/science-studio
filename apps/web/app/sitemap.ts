...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {url: `${siteUrl}/teaching-guides/physics-simulations-classroom-projector`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/series-and-parallel-circuits`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/ohms-law-interactive-circuit`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/density-and-buoyancy`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/total-internal-reflection`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/momentum-conservation`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/levers-and-moments`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/sound-waves`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/electromagnets`, changeFrequency: "monthly", priority: 0.8},
    {url: `${siteUrl}/teaching-guides/converging-lenses`, changeFrequency: "monthly", priority: 0.8},
