      ...
      <div className="pack-access-main">
        ...
        <section className="pack-access-layout">
          ...
          <div className="pack-access-card">
            ...
            <p>Unlock the full Middle School Physics Foundations pack, including DC Circuits, Waves, Density &amp; Buoyancy, and every released experiment added to this pack.</p>
