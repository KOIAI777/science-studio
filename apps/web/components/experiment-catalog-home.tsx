...
const copy = {
  en: {
    ...
    middleDesc: "A focused paid pack of circuit, wave, density, force, motion, energy, and momentum lessons for middle school.",
  ...
  "zh-CN": {
    ...
    middleName: "初中物理基础包",
    middleDesc: "围绕电路、波、密度、力、运动、能量与动量组织的初中付费课堂实验。",
    highName: "高中力学包",
