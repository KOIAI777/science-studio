...
const copy = {
  en: {
    ...
    heroNote: "No student accounts required. Three mechanics experiments are free.",
    ...
    libraryBody: "Start with three free mechanics experiments today. New grade levels and subjects will appear only after their lessons are classroom-ready.",
    ...
    currentAccess: "Inclined Plane, Energy Track, and Forces & Motion available now",
    expanding: "Three complete classroom experiments",
    ...
    faq: [
      ...
      {q: "Which grade levels are supported?", a: "The library is organized into elementary, middle school, and high school. The three released experiments currently target middle-school mechanics; other levels remain planned."},
      ...
      {q: "What can I use for free?", a: "Inclined Plane & Friction, Energy Track, and Forces & Motion are free now, including parameter controls, synchronized measurements, science checks, and guided explanation steps."},
    ],
    finalTitle: "Make the next physics explanation visible.",
    finalBody: "Open any free mechanics lesson and test the full classroom workflow.",
  ...
  "zh-CN": {
    ...
    currentAccess: "斜面、能量轨道和力与运动现已开放",
    expanding: "三个完整课堂实验",
